...
export const FONT_SIZE_BASE: number | undefined = calc('1rem'); // Assumes the browser default, typically `16px`
...
export const LINE_HEIGHT_BASE: number = 1.5;
...
export const HEADINGS_FONT_WEIGHT: number = 500;
export const HEADINGS_LINE_HEIGHT: number = 1.2;
...
export const BLOCKQUOTE_FONT_SIZE: number = calc(`${FONT_SIZE_BASE} * 1.25`);
...
export const LEGEND_MARGIN_BOTTOM: number | undefined = calc('1rem / 2');
export const LEGEND_FONT_SIZE: number | undefined = calc('1.5rem');
